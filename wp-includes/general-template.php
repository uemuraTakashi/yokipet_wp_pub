 ...
 *
 * An example of the 'base' argument is "http://localhost/wp1/all_posts.php%_%"
...
function paginate_links( $args = '' ) {
	...
	$defaults = array(
		'base'               => $pagenum_link, // http://localhost/wp1/all_posts.php%_% : %_% is replaced by format (below)
